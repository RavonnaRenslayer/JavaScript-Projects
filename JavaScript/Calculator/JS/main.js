...
//This modifies the values each time a button is clicked on.
function Input_Digit(digit) {
    const {Display_Value, Wait_Second_Operand } = Calculator;
    //This checks if the second Wait_Second_Operand is true and sets Display_Value
...
//This function updates the calculator screen with the contents of Dilapy_Value
